...
part of 'artifact_item_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ArtifactItem _$ArtifactItemFromJson(Map<String, dynamic> json) => ArtifactItem(
      ...
      properties: ArtifactItem._parseProperties(json['properties']),
...
Map<String, dynamic> _$ArtifactItemToJson(ArtifactItem instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'properties': ArtifactItem._stringifyProperties(instance.properties),
